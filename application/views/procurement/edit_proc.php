                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <form method="post" action="<?= site_url('procurement/sunting_proc'); ?>">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input name="kebutuhan" type="text" class="form-control" id="inputKebutuhan" value="<?= $procurement->kebutuhan; ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputKuantitas" class="col-sm-2 col-form-label">Kuantitas</label>
                                    <div class="col-sm-4">
                                        <input name="kuantitas" type="number" class="form-control" id="inputKuantitas" value="<?= $procurement->kuantitas; ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" id="satuan_id" name="satuan">
                                            ...
                                            <?php foreach ($satuan as $unit) { ?>
                                                <option value="<?php echo $unit->id_satuan; ?>" <?= $unit->id_satuan == $procurement->satuan ? "selected" : ""; ?>> <?php echo $unit->nama_satuan; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <textarea name="keterangan" class="form-control" id="inputKeterangan"><?= $procurement->keterangan; ?></textarea>
                                    </div>
                                </div>
