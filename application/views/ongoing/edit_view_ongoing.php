                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            Edit View Data Biaya Operasional
                        </div>
                        <div class="card-body">
                            <?php
                            ...
                            <?php } ?>
                            <form method="post" action="<?= site_url('ongoing/sunting_view_ongoing'); ?>">
                                <input type="hidden" name="ambil_data" value="<?= $this->uri->segment(3); ?>">
                                <div class="row mb-3">
                                    <label for="inputDeskripsi" class="col-sm-2 col-form-label">Deskripsi</label>
                                    <div class="col-sm-4">
                                        <input name="deskripsi" type="text" class="form-control" id="inputDeskripsi" value="<?= $view_operasional->deskripsi; ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputKuantitas" class="col-sm-2 col-form-label">Kuantitas</label>
                                    <div class="col-sm-4">
                                        <input name="kuantitas" type="number" class="form-control" id="inputKuantitas" value="<?= $view_operasional->kuantitas; ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" id="satuan_id" name="satuan">
                                            ...
                                            <?php foreach ($satuan as $unit) { ?>
                                                <option value="<?php echo $unit->id_satuan; ?>" <?= $unit->id_satuan == $view_operasional->satuan ? "selected" : ""; ?>> <?php echo $unit->nama_satuan; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input name="harga_satuan" type="number" class="form-control" id="inputHargaSatuan" value="<?= $view_operasional->harga_satuan; ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputKeterangan" class="col-sm-2 col-form-label">Keterangan</label>
                                    <div class="col-sm-4">
                                        <textarea name="keterangan" class="form-control" id="inputKeterangan"><?= $view_operasional->keterangan; ?></textarea>
                                    </div>
                                </div>
