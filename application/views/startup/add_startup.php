                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            Tambah Data Biaya Persiapan Operasional
                        </div>
                        <div class="card-body">
                            <?php
                            ...
                            <?php } ?>
                            <form method="post" action="<?= site_url('startup/isi_startup'); ?>">
                                <div class="row mb-3">
                                    <label for="inputKebutuhan" class="col-sm-2 col-form-label">Nama / Kebutuhan</label>
                                    <div class="col-sm-4">
                                        <input name="kebutuhan" type="text" class="form-control" id="inputKebutuhan">
                                    </div>
                                </div>
                                <div class="row mb-3">
