                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            Edit Data Manfaat Tidak Berwujud
                        </div>
                        <div class="card-body">
                            <?php
                            ...
                            <?php } ?>
                            <form method="post" action="<?= site_url('intangible_benefit/sunting_itb'); ?>">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input name="manfaat" type="text" class="form-control" id="inputManfaat" value="<?= $intangible_benefit->manfaat; ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputKuantitas" class="col-sm-2 col-form-label">Kuantitas</label>
                                    <div class="col-sm-4">
                                        <input name="kuantitas" type="number" class="form-control" id="inputKuantitas" value="<?= $intangible_benefit->kuantitas; ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" id="satuan_id" name="satuan">
                                            ...
                                            <?php foreach ($satuan as $unit) { ?>
                                                <option value="<?php echo $unit->id_satuan; ?>" <?= $unit->id_satuan == $intangible_benefit->satuan ? "selected" : ""; ?>> <?php echo $unit->nama_satuan; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input name="tarif" type="number" class="form-control" id="inputTarif" value="<?= $intangible_benefit->tarif; ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputKeterangan" class="col-sm-2 col-form-label">Keterangan</label>
                                    <div class="col-sm-4">
                                        <textarea name="keterangan" class="form-control" id="inputKeterangan"><?= $intangible_benefit->keterangan; ?></textarea>
                                    </div>
                                </div>
